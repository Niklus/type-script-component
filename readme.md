...
```html
<script type="module" src="https://unpkg.com/type-script-webcomponent@0.0.3/dist/type-script-component/type-script-component.esm.js"></script>
```
...
- Put a script tag similar to this `<script type='module' src='https://unpkg.com/type-script-webcomponent@0.0.3/dist/type-script-component/type-script-component.esm.js'></script>` in the head of your index.html
